...
import 'package:eshop_plus/ui/explore/productDetails/widgets/customerPhotoContainer.dart';
    ...
    Future.delayed(Duration.zero, () {
      ...
      context.read<ProductRatingCubit>().getProductRating(
          params: {
            ...
            ApiURL.limitApiKey: widget.isFullScreen ? limit : 3,
    ...
    return BlocConsumer<ProductRatingCubit, ProductRatingState>(
      listener: (context, state) {
        if (state is ProductRatingSuccess) {
          ...
          ratingsBreakdown = {
            5: state.productRating.star5.toString(),
            4: state.productRating.star4.toString(),
            3: state.productRating.star3.toString(),
            2: state.productRating.star2.toString(),
            1: state.productRating.star1.toString(),
          };
        }
      },
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  Text(
                      '$totalRatings ${context.read<SettingsAndLanguagesCubit>().getTranslatedValue(labelKey: ratingsKey)}',
                  ...
                  Text(
                      '$totalReviews ${context.read<SettingsAndLanguagesCubit>().getTranslatedValue(labelKey: reviewsKey)}',
                      style: Theme.of(context).textTheme.bodySmall!.copyWith(
                          color: Theme.of(context)
                              .colorScheme
                              .secondary
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    CustomTextContainer(
                      textKey: AppLocalizations.get(
                        context,
                        'all_reviews',
                        placeholders: {'total': state.total.toString()},
                      ),
                      style: Theme.of(context).textTheme.titleMedium,
                    ),
